...
namespace backend.Application.Features.Nomina.Queries
{
    ...
    public class ObtenerEventosCalendarioQueryHandler
    {
        ...
        public async Task<IResult> HandleAsync(ObtenerEventosCalendarioQuery query)
        {
            ...
            try
            {
                // Histórico de nóminas procesadas en este año y mes
            ...
            // Reglas de estado para eventos automáticos
            ...
            // Evento automático para supervisar y procesar quincena
            if (targetAnio == hoy.Year && targetMes == hoy.Month)
            {
                ...
                // Evento automático para despacho de volantes por correo
            ...
            // Eventos personalizados creados por usuarios
            try
            {
