...
export const ActionsDropdown: React.FC<ActionsDropdownProps> = ({
  ...
  const { canManageUsers, canCreateEmployee, canProcessPayroll } = useAuthorization();
  useEffect(() => {
  ...
  const isVisibleMap: Record<string, boolean> = {
    ...
    create: currentView !== 'create-employee' && currentView !== 'edit-employee' && Boolean(onNavigateToCreate) && canCreateEmployee,
    payroll: currentView !== 'payroll-processing' && Boolean(onNavigateToPayroll) && canProcessPayroll, 
    ...
    users: currentView !== 'users-management' && Boolean(onNavigateToUsers) && canManageUsers,
  };
