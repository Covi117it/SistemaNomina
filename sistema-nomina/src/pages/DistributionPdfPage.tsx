...
export const DistributionPdfPage: React.FC<DistributionPdfPageProps> = ({
  ...
  const { canSendPaystubs } = useAuthorization();
      ...
      <PageHeader
        ...
        actions={
          canSendPaystubs ? (
            ...
            <div className="px-3.5 py-2 bg-amber-50 border border-amber-200 text-amber-800 text-xs font-bold rounded-xl flex items-center gap-2">
              Modo Consulta: Vista previa de volantes
            </div>
          )
        }
      />
