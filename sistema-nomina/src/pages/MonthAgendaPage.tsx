...
export const MonthAgendaPage: React.FC<MonthAgendaPageProps> = ({
  ...
  const { canManageEvents, canProcessPayroll, canSendPaystubs } = useAuthorization();
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                              {isAuto1 && onNavigateToPayroll && canProcessPayroll && (
                                <button
                              ...
                              {isAuto2 && onNavigateToDistribution && canSendPaystubs && (
                                <button
                              ...
                              {!isAuto1 && !isAuto2 && !isCompleted && canManageEvents && (
